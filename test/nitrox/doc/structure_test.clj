(ns nitrox.doc.structure-test
  (:use midje.sweet)
  (:require [nitrox.doc.structure :refer :all]))

^{:refer nitrox.doc.structure/inclusive :added "0.1"}
(fact "determines which sections are contained by the other"
 ...
 ^{:refer nitrox.doc.structure/seperate :added "0.1"}
(fact "groups elements in an array "
  (seperate #(= 1 %) [1 2 2 1 3 4 5])
  => [[1 2 2] [1 3 4 5]])

^{:refer nitrox.doc.structure/containify :added "0.1"}
...
^{:refer nitrox.doc.structure/structure :added "0.1"}
