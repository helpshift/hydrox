(ns hydrox.doc.render.structure-test
  (:use midje.sweet)
  (:require [hydrox.doc.render.structure :refer :all]))

^{:refer hydrox.doc.render.structure/inclusive :added "0.1"}
(fact "determines which sections are contained by the other"
 ...
 ^{:refer hydrox.doc.render.structure/seperate :added "0.1"}
(fact "groups elements in an array "
  (seperate #(= 1 %) [1 2 2 1 3 4 5])
  => [[1 2 2] [1 3 4 5]])

^{:refer hydrox.doc.render.structure/containify :added "0.1"}
...
^{:refer hydrox.doc.render.structure/structure :added "0.1"}
